...
@Transactional
public class AdminStoreProductServiceTest {
    @InjectMocks
    private AdminStoreProductServiceImpl adminStoreProductService;
    @Mock
    ...
    public void getProductsTest() {
        ...
        // when
        Page<ProductListResponse> products = this.adminStoreProductService.getProducts(page, size);
    ...
    public void getProductTest() {
        ...
        // when
        ProductDetailResponse productDetailResponse = this.adminStoreProductService.getProduct(id);
    ...
    public void getProductFailNotFoundTest() {
        ...
        BusinessException exception = assertThrows(BusinessException.class, () -> {
            adminStoreProductService.getProduct(id);
        });
    ...
    public void createProductFailCategoryNotFoundTest() {
        ...
        // when
        BusinessException exception = assertThrows(BusinessException.class, () -> {
            adminStoreProductService.createProduct(productRequest);
        });
    ...
    public void modifyProductFailNotFoundTest() {
        ...
        // when
        BusinessException exception = assertThrows(BusinessException.class, () -> {
            adminStoreProductService.modifyProduct(id, any());
        });
    ...
    public void modifyProductFailCategoryNotFoundTest() {
        ...
        // when
        BusinessException exception = assertThrows(BusinessException.class, () -> {
            adminStoreProductService.modifyProduct(id, productRequest);
        });
