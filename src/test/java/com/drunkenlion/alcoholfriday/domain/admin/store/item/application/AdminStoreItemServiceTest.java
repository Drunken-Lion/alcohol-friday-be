...
@Transactional
public class AdminStoreItemServiceTest {
    @InjectMocks
    private AdminStoreItemServiceImpl adminStoreItemService;
    @Mock
    ...
    public void getItemsTest() {
        ...
        // when
        Page<ItemListResponse> products = this.adminStoreItemService.getItems(page, size);
    ...
    public void getItemTest() {
        ...
        // when
        ItemDetailResponse itemDetailResponse = this.adminStoreItemService.getItem(itemId);
    ...
    public void getItemFailNotFoundTest() {
        ...
        BusinessException exception = assertThrows(BusinessException.class, () -> {
            adminStoreItemService.getItem(itemId);
        });
    ...
    public void modifyItemTest() {
        ...
        // When
        ItemDetailResponse itemDetailResponse = adminStoreItemService.modifyItem(itemId, itemRequest);
    ...
    public void deleteItemTest() {
        ...
        // When
        adminStoreItemService.deleteItem(itemId);
