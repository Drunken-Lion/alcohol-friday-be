package com.drunkenlion.alcoholfriday.domain.admin.restaurant.order.dto;
...
@Schema(description = "레스토랑 발주 리스트 응답 항목")
public class RestaurantOrderListResponse {
    ...
    private List<RestaurantOrderDetailResponse> orderDetails;

    public static RestaurantOrderListResponse of(
            RestaurantOrder restaurantOrder,
            List<RestaurantOrderDetailResponse> restaurantOrderDetailResponses) {
