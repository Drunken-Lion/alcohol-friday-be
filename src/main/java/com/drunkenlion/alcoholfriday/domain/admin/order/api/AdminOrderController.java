...
public class AdminOrderController {
    ...
    public ResponseEntity<PageResponse<OrderListResponse>> getOrders(
        ...
        PageResponse<OrderListResponse> pageResponse;
        if (status != null) {
            pageResponse = PageResponse.of(this.adminOrderService.getOrdersByOrderStatus(page, size, status));
        } else {
            pageResponse = PageResponse.of(this.adminOrderService.getOrders(page, size));
        }
